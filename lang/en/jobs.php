...
return [
    ...
    'learning_heroes_1' => 'Web Development Team Leader for an Andorran Company',
    'learning_heroes_2' => 'Renovation of the company\'s entire web software from scratch, building a microservices - based architecture',
    'learning_heroes_3' => 'My main job is to oversee and control the technical quality of all developments',
    'learning_heroes_4' => 'Leading and synchronizing a small team of developers to build a system that is as robust, scalable, and maintainable as possible',
    'learning_heroes_5' => 'The technology stack consisted primarily of JS, using NuxtJS for the front end and NestJS or Express for the back end',
    'learning_heroes_6' => 'The company specializes in AI, which is why we also develop multiple AI - based tools, from assistants to automated systems',
    'learning_heroes_7' => 'We also integrate AI into our development tools to speed up time and reduce effort',
];
